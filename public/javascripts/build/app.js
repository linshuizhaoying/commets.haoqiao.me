...
render: function() {
    ...
    return (
			React.createElement("div", {className: "media note"}, 
				React.createElement("a", {className: "pull-left"}, 
				  React.createElement("div", {className: "img-circle comments-avatar img-admin"})
				), 
				React.createElement("div", {className: "media-body"}, 
					React.createElement("h5", {className: "media-heading"}, 
					  React.createElement("span", {className: "badge badge-success"}, "临水照影"), 
						React.createElement("span", null, "回复于", 
						 this.props.reply[0].createTime
						)
					), 
				React.createElement("p", null, this.props.reply[0].comment), 
...
},{"./content.jsx":160,"react":156}],159:[function(require,module,exports){
var React = require('react');
...
render: function() {
	  ...
	  if(this.props.lock == "t"){
	    return (
				React.createElement("div", {className: "media note animated bounceInRight"}, 
					React.createElement("h3", {className: "label label-md label-info"}, "链接来自:", this.props.link, " 主题:", this.props.title), 
					React.createElement("a", {className: "pull-left"}, 
					  React.createElement("div", {className: "img-circle comments-avatar img-guest"})
					), 
					React.createElement("div", {className: "media-body"}, 
						React.createElement("h5", {className: "media-heading"}, 
						  React.createElement("span", {className: "badge badge-success"}, this.props.guest), " 发布于",  
					...
					React.createElement("hr", null), 
					React.createElement(Admin, {key: this.props.reply.id, reply: this.props.reply})
					)
				)
    )
	  }else{
					...
					React.createElement("div", {className: "media-body"}, 
						React.createElement("h5", {className: "media-heading"}, 
						  React.createElement("span", {className: "badge badge-success"}, this.props.guest), " 发布于",  
							React.createElement("span", null, 
							  this.props.createTime, 
								React.createElement("div", {className: "btn btn-danger pull-right", "data-toggle": "modal", "data-target": "#myModal", onClick: this.handleClick}, "Reply")
							)
						), 
					React.createElement("p", null, this.props.comment), 
					React.createElement("hr", null), 
...
},{"./admin.jsx":157,"react":156}],160:[function(require,module,exports){
var React = require('react');
...
render: function() {
	  ...
	  var lock = $("#lock").text();
		if(datas){
	      ...
	      return React.createElement(Comments, {lock: lock, adminpass: adminpass, uid: Item._id, key: Item.id, title: Item.title, guest: Item.guest, comment: Item.content, link: Item.link, email: Item.email, createTime: Item.createTime, reply: Item.reply})
	    });
    }
    return (
			React.createElement("div", {className: "portlet box blue"}, 
				React.createElement("div", {className: "portlet-title"}, 
					React.createElement("h3", {className: "caption-subject bold uppercase text-center"}, "评论系统")
				), 
				React.createElement("div", {className: "portlet-body"}, 
				  CommentItems, 
				  React.createElement(SubmitComment, null)
				), 
				  ...
				  React.createElement("div", {className: "modal-dialog", role: "document"}, 
				    React.createElement("div", {className: "modal-content"}, 
				      ...
				      React.createElement("div", {className: "modal-body"}, 
								React.createElement("div", {className: "form-group form-md-line-input form-md-floating-label"}, 
									React.createElement("span", {id: "AdminReply", className: "hide"}), 
									React.createElement("textarea", {id: "AdminComment", ref: "AdminContent", rows: "6", className: "form-control textarea-style"}
									), 
				      ...
				      React.createElement("div", {className: "modal-footer"}, 
				        ...
				        React.createElement("button", {type: "button", className: "btn btn-primary", onClick: this.adminSubmit}, "提交")
				      )
				    )
				  )
				)
...
},{"./comments.jsx":159,"./submitComment.jsx":161,"react":156}],161:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
	...
	render: function() {
	    return (
				React.createElement("div", {className: "portlet light"}, 
					React.createElement("div", {className: "portlet-title"}, 
						React.createElement("div", {className: "caption font-green"}, 
							React.createElement("i", {className: "icon-pin font-green"}), 
							React.createElement("span", {className: "caption-subject bold uppercase"}, " 发表评论")
						)
					), 
					React.createElement("div", {className: "portlet-body form"}, 
						React.createElement("form", {role: "form"}, 
						React.createElement("div", {className: "form-body"}, 
							React.createElement("div", {className: "form-group form-md-line-input form-md-floating-label"}, 
								React.createElement("input", {id: "CommentName", ref: "CommentName", type: "text", className: "form-control", onChange: this.handleChange}), 
								React.createElement("label", {for: "CommentName"}, "昵称："), 
								React.createElement("span", {className: "help-block"}, "随便填")
							), 
							React.createElement("div", {className: "form-group form-md-line-input form-md-floating-label"}, 
								React.createElement("input", {id: "CommentEmail", ref: "CommentEmail", type: "text", className: "form-control", onChange: this.handleChange}), 
								React.createElement("label", {for: "CommentEmail"}, "邮箱"), 
								React.createElement("span", {className: "help-block"}, "=-=反正我不作检验,收不到邮件别怪我")
							), 
							React.createElement("div", {className: "form-group form-md-line-input form-md-floating-label"}, 
								React.createElement("textarea", {id: "CommentContent", ref: "CommentContent", rows: "3", className: "form-control textarea-style", onChange: this.handleChange}
								), 
								React.createElement("label", {for: "CommentContent"}, "评论内容")
							)
					 ), 
							React.createElement("div", {className: "form-actions noborder"}, 
								React.createElement("button", {type: "button", onClick: this.handleSubmit, className: "btn blue"}, "提交"), 
								React.createElement("button", {type: "button", onClick: this.handleCancel, className: "btn default commentCancel"}, "取消")
							)
						)
					)
				)
